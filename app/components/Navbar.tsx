...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 w-full z-50 bg-black text-white backdrop-blur-md shadow-sm transition-all duration-500"
    >
              ...
              {navLinks.map((link) => (
                <a
                  ...
                  className={`text-lg font-medium ${
                    activeSection === link.id ? 'font-semibold underline' : ''
                  }`}
                >
                  {link.label}
                </a>
